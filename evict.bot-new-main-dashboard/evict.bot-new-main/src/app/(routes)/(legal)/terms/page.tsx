    ...
    return (
        <div className="flex flex-col mx-[10vw] mt-5 sm:mx-[25vw]">
            ...
            <span className="text-evict-pink italic text-sm mt-5">
                Last updated And Effective Since: 2025-01-21
            </span>
            <span className="text-neutral-400 text-sm mt-5 pb-5">
                By visiting (&apos;Evict&apos;) or inviting (&apos;Evict Bot&apos;) to your Discord or
                logging into our website (&apos;evict.bot&apos;), you agree and consent to the terms
                displayed on this page including our policies (Privacy Policy). When we state
                &apos;Evict&apos;, &apos;we&apos;, &apos;us&apos;, and &apos;our&apos; in these
                terms, we mean Evict. &apos;Services&apos; mean Evict&apos;s services that we offer to
                users.
            </span>
            ...
            <span className="font-bold text-2xl text-white pt-10">Service Classification</span>
            <span className="text-neutral-400 text-sm mt-5">
                By using the Service, you acknowledge and agree that:
            </span>
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                <li className="text-neutral-400 marker:text-evict-pink">
                    The Service is classified as &quot;NSFW&quot; (Not Safe For Work) in accordance with Discord&apos;s platform requirements, which mandate such classification for any application containing NSFW functionality, regardless of scope.
                </li>
                <li className="text-neutral-400 marker:text-evict-pink">
                    This classification exists despite NSFW commands constituting less than 3% of the Service&apos;s total functionality.
                </li>
                <li className="text-neutral-400 marker:text-evict-pink">
                    All NSFW content and related commands are programmatically restricted to Discord channels explicitly marked as NSFW, in compliance with Discord&apos;s Terms of Service.
                </li>
                <li className="text-neutral-400 marker:text-evict-pink">
                    The predominant functionality of the Service (exceeding 97% of features) remains suitable for users aged 13 and above, in accordance with Discord&apos;s general usage terms.
                </li>
                <li className="text-neutral-400 marker:text-evict-pink">
                    This NSFW classification does not indicate the Service&apos;s primary purpose and exists solely for compliance with Discord&apos;s platform policies.
                </li>
            </div>

            <span className="font-bold text-2xl text-white pt-10">Disclaimer</span>
            <span className="text-neutral-400 text-sm mt-5">
                You may not use Evict to violate any applicable laws or regulations as well as
                ...
                <span className="text-white font-semibold">support@evict.bot</span>. If you are
            ...
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                ...
                <li className="text-neutral-400 marker:text-evict-pink">
                    Commands labeled as 18+ shall only be used by users 18+, anybody under 18 using these commands are subject to blacklist.
                </li>
            </div>
            ...
            <span className="font-bold text-2xl text-white pt-10">Biolinks Usage</span>
            <span className="text-neutral-400 text-sm mt-5">
            ...
            <span className="text-neutral-400 text-sm mt-5">
                We reserve the right to revoke access to biolinks or all our services at any time without prior notice. 
                If you encounter violations, you may:
            </span>
            <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                <li className="text-neutral-400 marker:text-evict-pink">
                ...
                <li className="text-neutral-400 marker:text-evict-pink">
                    Email us at <span className="text-white font-semibold">contact@evict.bot</span>
                </li>
            </div>
            <span className="text-neutral-400 text-sm mt-5">
                Violations of these terms or our privacy policy may result in an immediate and permanent ban across all our services. 
                We maintain zero tolerance for abuse of our biolinks service.
            </span>
        </div>
    )
}
