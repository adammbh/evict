...
class DynamicRoleButton(
    ...
    def __init__(self, message_id: int, role_id: int, emoji: Emoji) -> None:
        super().__init__(
            Button(
    ...
    async def callback(self, interaction: Interaction) -> None:
        ...
        if role in member.roles:
            ...
            return await interaction.embed(f"Removed role {role.mention} from you")

        await member.add_roles(role)
        return await interaction.embed(f"Added role {role.mention} to you")
