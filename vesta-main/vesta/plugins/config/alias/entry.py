...
class _TrackingFormatter(Formatter):
    """
    Custom string formatter that tracks the maximum index of
    positional arguments used in the format string.
    """
...
class AliasEntry:
    ...
    async def get(cls, guild: Guild, name: str) -> Optional[AliasEntry]:
        """
        Class method to retrieve an alias from the database.
        """
