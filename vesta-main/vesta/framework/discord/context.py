...
from vesta.framework.tools import Button, View
...
from discord.ext.commands import Context as DefaultContext, UserInputError
...
if TYPE_CHECKING:
    ...
    from vesta.shared.config import Configuration
...
class Context(DefaultContext):
    ...
    async def embed(
        ...
        **kwargs,
        ...
        Supported message types: approved, warned, denied, neutral
        """
    ...
    async def approve(self, interaction: Interaction):
        if interaction.user != self.user:
            return await interaction.response.send_message(
                f"Only **{self.user}** can respond to this!", ephemeral=True
            )
